      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 items-stretch">
            ...
            >
              <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-game-option-a to-game-option-b">
            ...
            >
              <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-violet-500 to-purple-600">
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-300" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <img 
            ...
            >
              <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-amber-500 to-orange-600">
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-300" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <img 
            ...
            {FEATURES.dramamatching && (
              ...
              >
                <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-pink-500 to-purple-600">
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-300" />
                  <div className="absolute inset-0 flex items-center justify-center">
            ...
            >
              <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-indigo-500 to-blue-600">
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-300" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-6xl">📋</div>
                </div>
            ...
            >
              <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-red-500 to-orange-600">
                <img
            ...
            >
              <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-blue-500 to-indigo-600">
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-300" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <img 
            ...
            >
              <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-purple-500 to-blue-500">
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-300" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-6xl">👑</div>
                </div>
            ...
            >
              <div className="relative overflow-hidden h-1/2 bg-gradient-to-br from-red-500 to-yellow-500">
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-300" />
              <div className="absolute inset-0 flex items-center justify-center">
                <img 
